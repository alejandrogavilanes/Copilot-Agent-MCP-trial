import {
  require_debug_logfmt,
  require_helpers
} from "./chunk-AOLAHMRW.js";
import "./chunk-EZTTJ27C.js";
import "./chunk-YL2MDBHH.js";
import {
  __commonJS,
  __esm,
  __export,
...
// node_modules/metascraper/node_modules/lodash/lodash.js
var require_lodash = __commonJS({
  "node_modules/metascraper/node_modules/lodash/lodash.js"(exports, module) {
    (function() {
      var undefined2;
      var VERSION = "4.17.21";
...
var require_rules = __commonJS({
  "node_modules/metascraper/src/rules.js"(exports, module) {
    ...
    var forEachRule = (collection, fn) => forEach(castArray(collection), fn);
    var loadRules = (rulesBundle) => chain(rulesBundle).reduce((acc, { test, pkgName, ...rules }) => {
      forEach(rules, (innerRules, propName) => {
        ...
        set(
          acc,
          propName,
          has2(acc, propName) ? concat(acc[propName], innerRules) : concat(innerRules)
        );
        return acc;
      });
      return acc;
    }, {}).toPairs().value();
    var mergeRules = (rules, baseRules) => chain(rules).reduce((acc, { test, ...rules2 }) => {
      forEach(rules2, (innerRules, propName) => {
        if (test) forEachRule(innerRules, (rule) => rule.test = test);
        const index2 = findIndex(acc, (item) => first2(item) === propName);
        if (index2 !== -1) acc[index2][1] = concat(innerRules, ...acc[index2][1]);
        else acc.push([propName, castArray(innerRules)]);
      });
      return acc;
    }, cloneDeep(baseRules)).value();
...
var require_get_data = __commonJS({
  "node_modules/metascraper/src/get-data.js"(exports, module) {
    "use strict";
    var debug = require_debug_logfmt()("metascraper:get-data");
    var { findRule, has: has2 } = require_helpers();
    var { map: map2, fromPairs } = require_lodash();
    var normalizeValue = (value) => has2(value) ? value : null;
    var getData = async ({ rules, name, ...props }) => {
      const data2 = await Promise.all(
        map2(rules, async ([propName, innerRules]) => {
