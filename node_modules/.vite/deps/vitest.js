...
function p(n = false) {
  let e = C(n), i = (r, t, c, o) => {
    ...
    let o = (l2) => {
      let s2 = String(l2), b = s2.indexOf(t, r.length);
...
function m2(e) {
  ...
  let t = function(...s2) {
    let r = T(t);
    r.called = true, r.callCount++, r.calls.push(s2);
    let S = r.next.shift();
    if (S) {
      r.results.push(S);
      let [o, g] = S;
    ...
    let p3, c = "ok", a3 = r.results.length;
    if (r.impl)
      try {
        new.target ? p3 = Reflect.construct(r.impl, s2, new.target) : p3 = r.impl.apply(this, s2), c = "ok";
      } catch (o) {
        throw p3 = o, c = "error", r.results.push([c, o]), o;
      }
    let R = [c, p3];
    return w(p3) && p3.then(
      (o) => r.resolves[a3] = ["ok", o],
      (o) => r.resolves[a3] = ["error", o]
    ), r.results.push(R), p3;
  };
...
function C2(e, t, n) {
  ...
  let R = false;
  r === "value" && a3 && !a3.value && a3.get && (r = "get", R = true, n = a3.get());
  let o;
  a3 ? o = a3[r] : r !== "value" ? o = () => e[s2] : o = e[s2];
  let g = (v) => {
    let { value: M, ...h3 } = a3 || {
      configurable: true,
      writable: true
    };
    r !== "value" && delete h3.writable, h3[r] = v, f2(e, s2, h3);
  }, b = () => a3 ? f2(e, s2, a3) : g(o);
  n || (n = o);
  let i = m2(n);
  r === "value" && O(i, o);
...
var _lazyMatch = () => {
  var __lib__ = (() => {
    var m3 = Object.defineProperty, V = Object.getOwnPropertyDescriptor, G = Object.getOwnPropertyNames, T2 = Object.prototype.hasOwnProperty, q = (r, e) => {
      for (var n in e) m3(r, n, { get: e[n], enumerable: true });
    }, H = (r, e, n, a3) => {
      if (e && typeof e == "object" || typeof e == "function") for (let t of G(e)) !T2.call(r, t) && t !== n && m3(r, t, { get: () => e[t], enumerable: !(a3 = V(e, t)) || a3.enumerable });
      return r;
    }, J = (r) => H(m3({}, "__esModule", { value: true }), r), w2 = {};
    q(w2, { default: () => re });
    var A = (r) => Array.isArray(r), d2 = (r) => typeof r == "function", Q = (r) => r.length === 0, W = (r) => typeof r == "number", K2 = (r) => typeof r == "object" && r !== null, X = (r) => r instanceof RegExp, b = (r) => typeof r == "string", h3 = (r) => r === void 0, Y = (r) => {
      ...
      return (a3) => {
        ...
        if (u2 > t) {
          if (!h3(e) && !a3.options.silent) {
            const s2 = a3.input.slice(t, u2), c = d2(e) ? e(s2, o, String(t)) : e;
      ...
      return g((o) => {
        ...
        if (u2) {
          if (!h3(e) && !o.options.silent) {
            const s2 = d2(e) ? e(...u2, o.input, String(o.index)) : e;
    ...
    }, tr = (r, e) => C4(r, 0, 1), f4 = (r, e) => C4(r, 0, 1 / 0), x2 = (r, e) => {
      const n = r.map(v);
      return g(_(M((a3) => {
      ...
      for (; r <= e; ) n.push(r++);
      return n;
    }, or = (r, e, n) => S(r, e).map((a3) => String(a3).padStart(n, "0")), R = (r, e) => S(O2(r), O2(e)).map(ir), p3 = (r) => r, z = (r) => ur((e) => rr(e, r, { memoization: false }).join("")), ur = (r) => {
      const e = {};
      return (n) => e[n] ?? (e[n] = r(n));
    }, sr = i(/^\*\*\/\*$/, ".*"), cr = i(/^\*\*\/(\*)?([ a-zA-Z0-9._-]+)$/, (r, e, n) => `.*${e ? "" : "(?:^|/)"}${n.replaceAll(".", "\\.")}`), lr = i(/^\*\*\/(\*)?([ a-zA-Z0-9._-]*)\{([ a-zA-Z0-9._-]+(?:,[ a-zA-Z0-9._-]+)*)\}$/, (r, e, n, a3) => `.*${e ? "" : "(?:^|/)"}${n.replaceAll(".", "\\.")}(?:${a3.replaceAll(",", "|").replaceAll(".", "\\.")})`), y2 = i(/\\./, p3), pr = i(/[$.*+?^(){}[\]\|]/, (r) => `\\${r}`), vr = i(/./, p3), hr = i(/^(?:!!)*!(.*)$/, (r, e) => `(?!^${L(e)}$).*?`), dr = i(/^(!!)+/, ""), fr = l2([hr, dr]), xr = i(/\/(\*\*\/)+/, "(?:/.+/|/)"), gr = i(/^(\*\*\/)+/, "(?:^|.*/)"), mr = i(/\/(\*\*)$/, "(?:/.*|$)"), _r = i(/\*\*/, ".*"), j = l2([xr, gr, mr, _r]), Sr = i(/\*\/(?!\*\*\/)/, "[^/]*/"), yr = i(/\*/, "[^/]*"), N = l2([Sr, yr]), k2 = i("?", "[^/]"), $r = i("[", p3), wr = i("]", p3), Ar = i(/[!^]/, "^/"), br = i(/[a-z]-[a-z]|[0-9]-[0-9]/i, p3), Cr = i(/[$.*+?^(){}[\|]/, (r) => `\\${r}`), Mr = i(/[^\]]/, p3), Er = l2([y2, Cr, br, Mr]), B2 = x2([$r, tr(Ar), f4(Er), wr]), Pr = i("{", "(?:"), Or = i("}", ")"), Rr = i(/(\d+)\.\.(\d+)/, (r, e, n) => or(+e, +n, Math.min(e.length, n.length)).join("|")), zr = i(/([a-z]+)\.\.([a-z]+)/, (r, e, n) => R(e, n).join("|")), jr = i(/([A-Z]+)\.\.([A-Z]+)/, (r, e, n) => R(e.toLowerCase(), n.toLowerCase()).join("|").toUpperCase()), Nr = l2([Rr, zr, jr]), I = x2([Pr, Nr, Or]), kr = i("{", "(?:"), Br = i("}", ")"), Ir = i(",", "|"), Fr = i(/[$.*+?^(){[\]\|]/, (r) => `\\${r}`), Lr = i(/[^}]/, p3), Zr = E(() => F), Dr = l2([j, N, k2, B2, I, Zr, y2, Fr, Ir, Lr]), F = x2([kr, f4(Dr), Br]), Ur = f4(l2([sr, cr, lr, fr, j, N, k2, B2, I, F, y2, pr, vr])), Vr = Ur, Gr = z(Vr), L = Gr, Tr = i(/\\./, p3), qr = i(/./, p3), Hr = i(/\*\*\*+/, "*"), Jr = i(/([^/{[(!])\*\*/, (r, e) => `${e}*`), Qr = i(/(^|.)\*\*(?=[^*/)\]}])/, (r, e) => `${e}*`), Wr = f4(l2([Tr, Hr, Jr, Qr, qr])), Kr = Wr, Xr = z(Kr), Yr = Xr, $ = (r, e) => {
...
function createSuiteCollector(name, factory = () => {
  ...
  const task = function(name2 = "", options = {}) {
    ...
    if (handler) {
      setFn(task2, withTimeout(withAwaitAsyncAssertions(withFixtures(handler, context), task2), timeout));
    }
...
var onTestFailed = createTestHook("onTestFailed", (test5, handler, timeout) => {
  test5.onFailed || (test5.onFailed = []);
  test5.onFailed.push(withTimeout(handler, timeout ?? getDefaultHookTimeout(), true, new Error("STACK_TRACE_ERROR")));
});
var onTestFinished = createTestHook("onTestFinished", (test5, handler, timeout) => {
  test5.onFinished || (test5.onFinished = []);
  test5.onFinished.push(withTimeout(handler, timeout ?? getDefaultHookTimeout(), true, new Error("STACK_TRACE_ERROR")));
});
...
// node_modules/vitest/dist/chunks/utils.CtocqOoE.js
...
async function saveInlineSnapshots(environment, snapshots) {
  const MagicString = (await import("./magic-string.es-KQKVUSU3.js")).default;
...
// node_modules/vitest/dist/chunks/date.CDOsz-HY.js
var RealDate = Date;
var now2 = null;
...
// node_modules/vitest/dist/chunks/vi.B-PuvDzu.js
var unsupported = [
  "matchSnapshot",
  "toMatchSnapshot",
...
// node_modules/vitest/dist/chunks/run-once.I7PpBOk1.js
...
// node_modules/vitest/dist/chunks/benchmark.BKUatJGy.js
...
// node_modules/vitest/dist/chunks/index.BDobFbcz.js
